...
namespace Joshua2.Controllers
{
    public class ArtistaController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(artistas); // ← Aquí se pasa una lista, no null
        }
        ...
        public async Task<IActionResult> Create([Bind("ArtistaId,Nombre,Pais")] Artista artista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ArtistaId,Nombre,Pais")] Artista artista)
        {
            if (id != artista.Id)
            {
                return NotFound();
